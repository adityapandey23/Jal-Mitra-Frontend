...
function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 backdrop-blur-md border-b-4 border-b-slate-200">
      <div className="container mx-auto my-5 px-5">
        <div className="flex justify-between items-center">
          {/* Logo Part */}
          <div className="flex justify-center items-center">
            <h2 className="text-3xl font-extrabold">Jal Mitra</h2>
            <img
              src={Logo}
          ...
          >
            ...
            {toggle ?
              <div className="flex p-6 bg-blue-200 absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl flex-col">
